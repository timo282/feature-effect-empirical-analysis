    ...
    for i in range(n_sim):
        ...
        for model in models:
            ...
            model = train_model(
                ...
                X_train,
                y_train,
                n_trials=config.getint("simulation_metadata", "n_trials"),
...
if __name__ == "__main__":
    ...
    n_train_config = sim_config.getint("simulation_params", "n_train")
    noise_sd_config = sim_config.getfloat("simulation_params", "noise_sd")
    models_config = [
