...
def simulate(
    ...
    for groundtruth in groundtruths:
        ...
        engine_effects_results = create_engine(
            f"sqlite:///{str(groundtruth)}{sim_metatadata['effects_results_storage']}"
        )
                ...
                for snr in snrs:
                    ...
                    for model in models:
                        ...
                        model = train_model(
                            ...
                            tuning_studies_folder=Path(str(groundtruth))
                            / Path(sim_metatadata["tuning_studies_folder"]),
